...
nohup $HIVE_HOME/bin/hive --service hiveserver2 --hiveconf hive.root.logger=DEBUG --hiveconf hive.log.file=hiveserver2.log --hiveconf hive.log.dir=/var/log/hive > /var/log/hive/hiveserver2.out &
while true; do
