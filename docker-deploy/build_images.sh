...
docker build --progress=plain --platform=linux/amd64 -t 15521147129/bigdata:debian-base -f base/Dockerfile .
...
docker push 15521147129/bigdata:flink-on-yarn-1.13.2
