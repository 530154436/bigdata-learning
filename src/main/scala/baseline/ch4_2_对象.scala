 ...
 *  编译：scalac src\main\scala\baseline\ch4_2_对象.scala
    “反编译”查看字节码 Person.class：
        > javap src.main.scala.baseline.Person
        Compiled from "ch4_2_对象.scala"
        public class src.main.scala.baseline.Person {
          public static int newPersonId();
          public void info();
          public src.main.scala.baseline.Person();
          public src.main.scala.baseline.Person(java.lang.String);
        }
 */
object ch4_2_对象 {
